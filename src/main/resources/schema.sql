...
-- Spring AI PgVectorStore default table (see PgVectorStore.afterPropertiesSet). Ensures the table
-- exists after this script runs (e.g. integration tests reset the DB without restarting the app).
